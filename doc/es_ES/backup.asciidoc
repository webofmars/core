...
** Tamaño total máximo de copias de seguridad (MB) *: permite limitar el tamaño total de las copias. Si se supera este valor Jeedom las eliminará. Asegúrese de dejar caer por debajo del tamaño máximo las copias de seguridad.
