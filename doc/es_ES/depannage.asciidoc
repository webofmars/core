...
Debe conectarse a  jeedom por SSHy lanzar un script de autodiagnóstico: 
...
Este error es debido a un problema con el sistema pero de no Jeedom. 
...
Se recomienda ver las ordenes ejecutadas por la escena, 
